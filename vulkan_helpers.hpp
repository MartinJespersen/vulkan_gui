...
void copyBufferToImage(VkCommandPool commandPool, VkDevice device, VkQueue queue, VkBuffer buffer, VkImage image, uint32_t width, uint32_t height)
{
    VkCommandBuffer commandBuffer = beginSingleTimeCommands(device, commandPool);
...
VkImageView createColorResources(VkPhysicalDevice physicalDevice,
                                 VkDevice device,
...
std::vector<VkFramebuffer> createFramebuffers(VkDevice device, VkImageView colorImageView, VkRenderPass renderPass, VkExtent2D swapChainExtent, std::vector<VkImageView> swapChainImageViews)
{
...
std::tuple<VkPipelineLayout, VkPipeline> createGraphicsPipeline(VkDevice device,
                                                                VkExtent2D swapChainExtent,
...
VkRenderPass createRenderPass(VkDevice device, VkFormat swapChainImageFormat, VkSampleCountFlagBits msaaSamples, VkAttachmentLoadOp loadOp, VkImageLayout initialLayout, VkImageLayout finalLayout)
{
