...
cxxflags="-Wall -Wextra -Werror -fsanitize=address -pedantic -Wconversion -Wsign-conversion -Wno-missing-field-initializers -Wno-write-strings -Wno-class-memaccess -Wno-pedantic -maes -msse4"
